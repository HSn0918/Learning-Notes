...
相关笔记：[[scheduler-framework-source]] | [[scheduler-assume]] | [[scheduler-deep-dive]] | [[volcano-source]] | [[gpu-scheduling-source]] | [[k8s-development-roadmap]] | [[demo-scheduler-plugin]]
...
- 读完 [[scheduler-assume]]，搞清 assume 只写调度器内存，bind 才写 API Server。
