...
相关笔记：[[scheduler-framework-source]] | [[scheduler-deep-dive]] | [[scheduler-assume]] | [[gpu-scheduling]] | [[gpu-scheduling-source]] | [[hami-source]] | [[k8s-development-roadmap]] | [[demo-scheduler-plugin]]
...
`cache.Bind` 是异步的，参考 [[scheduler-assume]] 里默认 kube-scheduler 的 assume 机制——Volcano 这里类似，Statement Commit 后 Pod 在 Session 视图里已经 "Allocated"，真正的 Binding 通过 cache 后台 goroutine 写 K8s。
