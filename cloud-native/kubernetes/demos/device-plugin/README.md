...
`learning-notes.io/fake-device` 的虚拟设备。配套阅读：
...
kubectl describe node | grep learning-notes.io/fake-device
# 期望输出:
#   learning-notes.io/fake-device: 8
```

应该能在 `Capacity` 和 `Allocatable` 两段中各看到一行 `learning-notes.io/fake-device: 8`，
    ...
    - name: app
      ...
      resources:
        limits:
          ...
          learning-notes.io/fake-device: 2
EOF
...
#   FAKE_RESOURCE_NAME=learning-notes.io/fake-device
...
- **Pod 一直 Pending，事件提示 `Insufficient learning-notes.io/fake-device`**：
