...
//
// 它向 kubelet 宣告 8 个虚拟设备 (learning-notes.io/fake-device-0 .. -7),
...
// 查看: kubectl describe node <node> | grep learning-notes.io/fake-device
package main
...
const (
	...
	pluginSockName = "learning-notes-fake-device.sock"
