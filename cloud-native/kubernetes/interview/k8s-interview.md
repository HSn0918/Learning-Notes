...
> [!question]- 参考答案（点击展开）
>
> 通过命令“[kubectl](https://so.csdn.net/so/search?q=kubectl&spm=1001.2101.3001.7020) explain pod.spec”查看pod的重启策略;
>
...
### Pod 中 command 和 args 参数与 Docker ENTRYPOINT 的关系
...
### 滚动更新的 maxUnavailable 和 maxSurge 参数
...
### K8s 生产中遇到的印象深刻的问题（keepalived 脑裂）
...
### K8s 生产中遇到的印象深刻的问题（etcd 双 Leader）

> [!question]- 参考答案（点击展开）
>
> 参考答案：测试环境二进制搭建etcd集群，etcd集群出现2个leader的现象。
...
>
> ![](https://cdn.nlark.com/yuque/0/2024/png/46821905/1727509201842-bce6641c-6c2c-4fb4-bf86-1d4b8439ae42.png)
...
>
> ![](https://cdn.nlark.com/yuque/0/2024/png/46821905/1727509203071-691ff717-bedf-4789-9345-84a87dd38391.png)
>
