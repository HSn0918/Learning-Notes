...
下面这段 60 行的 Go 骨架展示了"启动一个最小 CSI gRPC server"的关键步骤：监听 unix socket、注册 Identity + Node service、信号处理。完整可编译版本在 `cloud-native/kubernetes/demos/csi-hostpath/`。
...
const driverName = "learning-notes.csi.k8s.io"
